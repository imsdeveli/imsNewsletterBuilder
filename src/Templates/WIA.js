...
<td style="display:none !important; visibility:hidden; mso-hide:all; font-size:1px; color:#ffffff; line-height:1px; max-height:0px; max-width:0px; opacity:0; overflow:hidden;">${props.ad1.Head}</td>
			</tr>
		</tbody>
	</table>
	<p style="margin-top:0em; margin-bottom:0em; font-size:1pt; line-height:1pt; color: #EFEFEF;"><a href="https://tracking.imspublishergroup.com/aff_c?offer_id=7632&aff_id=1436&url_id=28254&source={{email}}" style="color: #EFEFEF; text-decoration: none;"></a></p>
			...
			<![endif]-->
				...
				<tr>
					<td align="left" valign="top" style="padding:10px 5px 10px 5px; font-family: Arial, sans-serif; font-size: 10px; line-height: 12px;  color: #000000;">
						...
						<p style="margin-bottom:1em;">At Weekly Investor Alerts, it’s our mission to create and provide a community that helps you invest and understand stocks. When weeklyinvestoralerts.com was established, we wanted to make the community an inclusive place where investors can come to get ahead! Not just help them with daily stock picks. Weekly Investor Alerts are provided to you for information only and should not be considered as a stock or investment advisor. Weekly Investor Alerts may make available certain information related to trading strategies and stock prices for educational and information purposes only; any information made available should not be construed as an endorsement, recommendation, or sponsorship of any company or security. By visiting this site or using the training materials, you acknowledge and agree that any reliance upon the content or data available through Weekly Investor Alerts is at your own sole risk. You are strongly advised to use your own judgment, research, and consult a professional advisor.</p>

							
						<p style="margin-bottom:1em;">Over the years, and with thousands of followers that use our stock picks daily, we promise to always aim to get better at what we do every single day! In addition, our primary focus is on our communication with you. It’s really important to us that every time you come to us, you end up leaving with the help you came for to take your investment portfolio to new levels.</p>
							
						<p style="margin-bottom:1em;">We particularly appreciate when our following provides feedback via testimonials, reviews, and comments left on our site or social media accounts. Because with that feedback, we can use it to make your next visit to our site even better than the last!</p> 
							
						<p style="margin-bottom:1em;">Since we put so much effort into the relationship with you, we hope that any investment in us is exactly the way you hoped it would be. Because by choosing to go with weeklyinvestoralerts.com, it’s our promise that we provide a community you will come back to over and over again.</p> 
							
						<p style="margin-bottom:1em;">Now, as much as we care about making investors more successful, we also care about your privacy. Weeklyinvestoralerts.com is owned and operated by Weeklyinvestoralerts.com.</p> 
							
						<p style="margin-bottom:1em;">We’re committed to the right to your privacy and strive to provide a safe and secure user experience. Our Privacy Policy explains how we collect, store and use personal information, provided by you on our website.</p> 
						...
						<p style="margin-bottom:1em;">Feel free to visit our site, find the privacy policy in the footer and read it. If there is something you are concerned about or wish to get more clarity on, please let us know by contacting us at support@Weeklyinvestoralerts.com. The Privacy Policy also informs you of how to notify us to stop using your personal information. If you wish to view our official policies, please visit our website <a href="https://weeklyinvestoralerts.com/" target="_blank" style="color: #00BAFF;">https://weeklyinvestoralerts.com/</a></p>

						<p style="margin-bottom:1em;">At Weekly Investor Alerts, we are strongly committed to protecting your privacy and providing a safe & high-quality online experience for all of our visitors. We understand that you care about how the information you provide to us is used and shared. We have developed a Privacy Policy to inform you of our policies regarding the collection, use, and disclosure of information we receive from users of our website. Weekly Investor Alerts operates the Website.</p>			
							
						<p style="margin-bottom:1em;">Our Privacy Policy, along with our Term & Conditions, governs your use of this site. By using https://weeklyinvestoralerts.com/, or by accepting the Terms of Use (via opt-in, checkbox, pop-up, or clicking an email link confirming the same), you agree to be bound by our Terms & Conditions and our Privacy Policy. If you have provided personal, billing, or other voluntarily provided information, you may access, review, and make changes to it via instructions found on the Website or by emailing us at support@weeklyinvestoralerts.com. To manage your receipt of marketing and non-transactional communications, you may unsubscribe by clicking the “unsubscribe” link located on the bottom of any marketing email. Emails related to the purchase or delivery of orders are provided automatically – Customers are not able to opt out of transactional emails. We will try to accommodate any requests related to the management of Personal Information in a timely manner. However, it is not always possible to completely remove or modify information in our databases (for example, if we have a legal obligation to keep it for certain timeframes, for example). If you have any questions, simply reply to this email or visit our website to view our official policies.</p>
