  ...
  <div role="article" aria-roledescription="email" lang="en" style="text-size-adjust:100%; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; background-color:#EFEFEF;">
    ...
    <table role="presentation" style="width:100%; border:none; border-spacing:0;">
      ...
      <!--START - MAIN CONTENT CONTAINER-->  
        <!--START - HEADER LOGO--> 
          <table role="presentation" style="width:94%; max-width:600px; border:none; border-spacing:0; text-align:left; font-family:Arial,sans-serif; font-size:16px; line-height:18pt; color:#6C6C6C; background-color:#000000;" bgcolor="#000000">
        <tr>
            <td style="padding:30px 0px 0px 0px; background-color:#FFFFFF;">
          <p style="margin-top:0em; margin-bottom:0em; text-align: center" align="center"><img src="http://cdn.mcauto-images-production.sendgrid.net/416b2593daeb264e/3f150518-4799-4421-ab82-8cf7cfd2fa73/1648x537.png" width="200" /></p>
          ...
          <div align="center" style="border-bottom:8px solid black;">&nbsp;</div>
            ...
            <tr>
              ...
              <p style="margin-bottom:1em; text-align: center;" align="center"><a href="#LINK" style="font-weight:bold; text-decoration: underline; color: #FF9933;" target="_blank">Sponsored Headline #1</a>&nbsp;<span style="color:#000000; font-weight:normal; font-size:10px; line-height:12px;">[ad]</span></p>
              
              <!--START - FEATURED ARTICLE - 1ST TWO PARAGRAPHS-->
              <h1 style="margin-top:1em; margin-bottom:1em; font-weight:bold; font-size:20pt; line-height:24pt;"><a href="#LINK" style="font-weight: bold; text-decoration:none; color:#363636;" target="_blank">EV Squeeze in Focus</a></h1>
              ...
              <p style="margin-bottom:0em; text-align: center; font-size: 12px; line-height:14pt;" align="center"></p>						
                <!--END - FEATURED ARTICLE - 1ST TWO PARAGRAPHS-->
              
              <div align="center" style="border-bottom:1px solid black; font-size: 12px; line-height:14pt;">CONTINUE READING BELOW</div>
              <!--START - OFFER 1-->	
                  <p style="margin-bottom:1em;"><a href="#LINK" style="font-weight:bold; text-decoration: none; color: #000000;" target="_blank">Sponsored Ad #1</a> <span style="color:#000000; font-weight:normal; font-size:10px; line-height:12px;">[ad]</span></p>
              
              <p style="margin-bottom:1em;">Sponsored Ad Copy #1&nbsp;<a href="#LINK" style="text-decoration:underline; font-weight: bold; color: #FF9933;" target="_blank">CTA</a></p>
                <!--END - OFFER 1-->
              <div align="center" style="border-top:1px solid black;">&nbsp;</div>
              
              <!--START - FEATURED ARTICLE - REMAINING PARAGRAPHS-->				  
              <p style="margin-top:1em; margin-bottom:1em;">The short answer is there is likely further pain in the space. The potential for bankruptcies is higher as it will be tougher to borrow money under the current monetary policy. That does not mean that traders cannot profit from oversold bounces. There will be some opportunities this week.</p>
              
              <p style="margin-top:1em; margin-bottom:1em;">EVs will be in focus as the <strong>Rivian Automotive (RIVN)</strong> lock-up expiration and a major auto summit grab headlines this week. Traders should have a few names ready in case we see volatility.</p>
              
              <p style="margin-bottom:1em; text-align: center; text-transform: uppercase; letter-spacing: 0.5px;" align="center"><a href="#LINK" style="background: #FF9933; text-decoration: none; padding: 10px 20px; color: #ffffff; border-radius: 12px; display:inline-block; mso-padding-alt:0; text-underline-color:#FF9933"><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%; mso-text-raise:20pt">&nbsp;</i><![endif]--><span style="mso-text-raise:10pt; font-weight:bold;">&nbsp;Full Story Here&nbsp;</span><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i><![endif]--></a></p>
              
                <!--END - FEATURED ARTICLE - REMAINING PARAGRAPHS-->
              
              <div align="center" style="border-bottom:1px solid black;">&nbsp;</div>
              <!--START - OFFER 2-->						
                  <p style="margin-bottom:0em;"><a href="#LINK" style="font-weight:bold; text-decoration: none; color: #000000;" target="_blank">Sponsored Ad #2</a> <span style="color:#000000; font-weight:normal; font-size:10px; line-height:12px;">[ad]</span><br>
              Sponsored Ad Copy #2&nbsp;<a href="#LINK" style="text-decoration:underline; font-weight: bold; color: #FF9933;" target="_blank">CTA</a></p>
                <!--END - OFFER 2-->
              <div align="center" style="border-bottom:1px solid black;">&nbsp;</div>
                </td>
            </tr>
          ...
          <table width="100%" bgcolor="#000000" cellpadding="5" cellspacing="0">
            ...
            <table role="presentation" style="width:100%; border:none; border-spacing:0; text-align:left; font-family:Arial,sans-serif; font-size:16px; line-height:18pt; color:#363636; background-color: #FFFFFF;" bgcolor="#FFFFFF">			
              <tr>
              <td style="padding:10px; background-color:#ffffff;"> 
                  <p style="margin-bottom:1em;"><a href="https://tracking.legacyoffers.com/aff_c?offer_id=286&aff_id=1671&eid=MKT627590&externalchannel=tci-email-relcont&aff_sub=tci-relcont-nl-lift5" style="font-weight:bold; text-decoration: underline; color: #FF9933;" target="_blank">$150 Trillion | Transformation of US | Bezos/Musk</a></p>
                  ...
                  <p style="margin-bottom:1em;"><a href="https://www.behindthemarkets-btm.com/3J67C/KMKS9/?source_id=relcont&sub1=tci&sub2=china-explode&sub3=nl" style="font-weight:bold; text-decoration: underline; color: #FF9933;" target="_blank">BREAKING: How China could "explode" your portfolio on June 21st. </a></p>
            
                  <p style="margin-bottom:1em;"><a href="https://www.c7bwtrk.com/5KCWZ2/293Z4R/?source_id=relcont&sub1=tci&sub2=revealed&sub3=nl" style="font-weight:bold; text-decoration: underline; color: #FF9933;" target="_blank">Bezos' NEXT Big Project Revealed! One that could disrupt a $1.32 trillion industry...</a></p><br><br>
